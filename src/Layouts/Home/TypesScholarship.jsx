...
const TypesScholarship = () => {
  return (
    <div className="max-w-[350px] md:max-w-3xl lg:max-w-4xl mx-auto mt-10 md:mt-16 lg:mt-20 mb-2 md:mb-7 lg:mb-10">
      <Fade cascade delay={100} direction="up">
        <h2 className="text-3xl md:text-5xl font-bold text-center pb-8 md:pb-14 font-oswald text-transparent bg-gradient-to-r from-[#333E50] to-[#03cfb8] bg-clip-text">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
        <Fade cascade delay={100} direction="up">
          ...
          <div className="max-w-sm p-4 bg-white rounded-lg shadow-md border border-gray-300 hover:shadow-xl hover:-translate-1 duration-500">
            ...
            <p className="text-gray-700 mt-2 text-md">
              Scholarships for international students are a golden opportunity
              to turn your dream of studying abroad into reality. These ...
            </p>
        ...
        <Fade cascade delay={50} direction="up">
          ...
          <div className="max-w-sm p-4 bg-white rounded-lg shadow-md border border-gray-300 hover:shadow-xl hover:-translate-1 duration-500">
            ...
            <p className="text-gray-700 mt-2 text-md">
              Scholarships for minority students play a crucial role in
              promoting diversity and inclusion in higher education. These
              scholarship...
            </p>
            <div className="mt-3 flex items-center justify-between text-[#59B890] text-sm font-medium">
              <span className="px-2 py-1 bg-gray-200 rounded-md text-gray-700 text-xs">
        ...
        <Fade cascade delay={50} direction="up">
          <div className="max-w-sm p-4 bg-white rounded-lg shadow-md border border-gray-300 hover:shadow-xl hover:-translate-1 duration-500">
            ...
            <p className="text-gray-700 mt-2 text-md">
              No-essay scholarships are an attractive option for students who
              want to minimise the time and effort involved in securing ...
            </p>
            <div className="mt-3 flex items-center justify-between text-[#59B890] text-sm font-medium">
              <span className="px-2 py-1 bg-gray-200 rounded-md text-gray-700 text-xs">
                7 min read
