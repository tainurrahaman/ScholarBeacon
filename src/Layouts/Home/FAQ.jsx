...
const FAQ = () => {
  return (
    <div className="py-10 px-5 font-mulish my-2 md:my-5 lg:my-10 bg-gray-100 rounded-sm">
      <h2 className="text-2xl md:text-5xl font-bold text-center md:text-start mb-2 md:mb-8 text-gray-800 font-oswald">
        Frequently Asked Question(<span className="text-[#0F7771]">FAQ</span>)
      </h2>
        ...
        <div className="join join-vertical flex-1">
          ...
          <div className="collapse collapse-arrow join-item border-b-2 border-gray-400">
            ...
            <div className="collapse-content text-[16px] font-semibold">
              ...
              without creating an account by visiting our Scholarship Directory.
          ...
          <div className="collapse collapse-arrow join-item border-b-2 border-gray-400">
            ...
            <div className="collapse-content text-[16px] font-semibold">
              ...
              updated daily, and each scholarship is verified to ensure accuracy
              and authenticity. We encourage users to report anything they may
              find suspicious or concerning and take the feedback we receive
              very seriously. ScholarBeacon NinetyOne.com has been a trusted
              resource for students, parents, and educators for over 25 years.
            </div>
          </div>
        </div>
        <div className="join join-vertical flex-1">
          <div className="collapse collapse-arrow join-item border-b-2 border-gray-400">
            ...
            <div className="collapse-content text-[16px] font-semibold">
              ScholarBeacon NinetyOne.com is one of the most trusted and widely
              used scholarship search platforms, featuring a verified and
              continuously updated scholarship database. Our comprehensive
          ...
          <div className="collapse collapse-arrow join-item border-b-2 border-gray-400">
            ...
            <div className="collapse-content text-[16px] font-semibold">
              Yes, ScholarBeacon NinetyOne.com is completely free to use. There
              are no fees to search for scholarships, create an account, or
              access any of our resources. Our goal is to help students find and
              win scholarships without any cost or obligation.
            </div>
          </div>
          <div className="collapse collapse-arrow join-item border-b-2 border-gray-400">
            <input type="radio" name="my-accordion-4" />
            ...
            <div className="collapse-content text-[16px] font-semibold">
              If you have a question about a scholarship, we recommend checking
              the scholarship listing first for details. Many listings include
              contact information for the provider, who can give the most
              accurate information. If you need further assistance or want to
              report an issue with a scholarship, you can contact us for
              support.
            </div>
          </div>
        </div>
